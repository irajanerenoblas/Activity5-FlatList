          ...
          onRequestClose={() => {
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                  {selectedUser && (
                    <Text style={{fontSize: 18, fontWeight: '600', fontFamily: 'Tahoma'}}> HELLO, {selectedUser.name}!
                    </Text>
                  )}
                  {selectedUser && (
                    <Text style={{fontWeight: '100', fontFamily: 'Tahoma', fontSize: 13}}>{selectedUser.place}</Text>
                  )}

                  <TouchableOpacity onPress={()=> setModalVisible(false)}>
                    <Text style={{marginTop: 25, fontSize: 15, color: '#695B5D', fontFamily: 'Tahoma'}}>Close</Text>
                  </TouchableOpacity>
